  ...
  return <main className="lab-shell">
    ...
    <section className="lab-main">
      ...
      <div className="workspace-grid">
        ...
        <aside className="results-card"><div className="card-kicker"><span className="eyebrow">RESULT LEDGER</span><span className="confidence">PREVIEW</span></div><div className="drag-readout"><span>{modified ? "Estimated drag force / modified" : "Estimated drag force / baseline"}</span><strong>{modified ? "30.6" : "31.8"}<small>N</small></strong><span className="delta positive">{modified ? "↓ 7.8% vs baseline" : "↓ 4.2% vs reference"}</span></div><div className="metric-list"><Metric label="CdA" value={modified ? "0.274" : "0.286"} unit="m²" tone="copper" /><Metric label="Power at speed" value="287" unit="W" /><Metric label="Air density" value="1.225" unit="kg/m³" /><Metric label="Flow state" value="Steady" /></div><div className="result-note"><Zap size={14} /><span>Measured values will appear after a CFD case is completed.</span></div><div className="wake-inset"><img src="/manus-storage/bicycle-aero-lab-wake_a66155fa.png" alt="Preview of a bicycle wake field" /><span>WAKE PREVIEW / NEXT SOLVER PASS</span></div></aside>
      </div>
