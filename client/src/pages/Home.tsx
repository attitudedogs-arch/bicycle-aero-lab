...
export default function Home() {
  ...
  const saveCase = () => {
    ...
    const nextCase: SavedCase = { id: createCaseId(), name: caseName.trim() || "Untitled geometry case", model: "Aero road / R-01", wheelbase, wheelDiameter, riderHeight, preparedAt: preparedAt.toISOString(), status: simulationStatus, flowModel, solverModel, turbulenceModel, groundCondition, meshTarget, boundaryLayerLayers, domainLength, iterations, residualExponent, referenceArea, characteristicLength, dynamicViscosity };
