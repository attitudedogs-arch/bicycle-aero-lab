...
import { Activity, CheckCircle2, ChevronDown, CircleHelp, Download, FileJson2, Gauge, Layers3, Play, RotateCcw, Settings2, Wind, Zap } from "lucide-react";
...
export default function Home() {
  ...
  const markGeometryChanged = () => { setGeometryStatus("Preview only"); setPreparedAt(null); };
  const prepareGeometry = () => { setGeometryStatus("Spec ready / mesh pending"); setPreparedAt(new Date()); };
  const downloadManifest = () => {
    const manifest = {
      ...
      readiness: { geometry: "simplified preview", mesh: "not generated", watertightCheck: "pending" },
